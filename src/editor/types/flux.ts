...
export type OnAddNode = (bodyID: string, funcName: string, declarationID: string) => void;
export type OnToggleYield = (bodyID: string, declarationID: string, funcNodeIndex: number) => void;
export type OnGenerateScript = () => void;
export type OnChangeScript = (script: string) => void;
export type ScriptUpToYield = (bodyID: string, declarationID: string, yieldNodeIndex: number, isYieldable: boolean) => string;
...
export type SetFilterTagValue = (key: string, value: string, selected: boolean) => void;
